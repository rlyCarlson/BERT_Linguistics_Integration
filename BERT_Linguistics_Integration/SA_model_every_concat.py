...
train_embeddings, train_labels = load_all_embeddings('/Users/ishaansingh/Documents/CS224N_FinalProject/SA_total_embeddings_cat_train', 85, "train")
test_embeddings, test_labels = load_all_embeddings('/Users/ishaansingh/Documents/CS224N_FinalProject/SA_total_embeddings_cat_test', 10, "test")
...
model = TextClassifier(input_size=768*3, hidden_size=128, num_classes=2).to(device)
optimizer = optim.Adam(model.parameters(), lr=0.001)
criterion = nn.CrossEntropyLoss() # built in softmax here
