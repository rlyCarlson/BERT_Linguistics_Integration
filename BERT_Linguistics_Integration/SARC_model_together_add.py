...
train_embeddings, train_labels = load_all_embeddings('/Users/ishaansingh/Documents/CS224N_FinalProject/SARC_total_embeddings_add_train', 22)
test_embeddings, test_labels = load_all_embeddings('/Users/ishaansingh/Documents/CS224N_FinalProject/SARC_total_embeddings_add_test', 7)

batch_size = 1000
train_dataset = TensorDataset(train_embeddings[:217082, :], train_labels)
