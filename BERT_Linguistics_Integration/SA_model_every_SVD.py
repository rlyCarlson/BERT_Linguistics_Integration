...
train_embeddings, train_labels = load_all_embeddings('/Users/ishaansingh/Documents/CS224N_FinalProject/SA_total_embeddings_svd_train', 85, "train")
test_embeddings, test_labels = load_all_embeddings('/Users/ishaansingh/Documents/CS224N_FinalProject/SA_total_embeddings_svd_test', 10, "test")
...
model = TextClassifier(input_size=1536 + 768, hidden_size=128, num_classes=2).to(device)
